# Firefox Policy Documentation Inventory (BPM 0.9.5.1)
...
| --- | --- | ---: | --- | --- |
| `release-153` | `153.0` | 122 | supported | default Release |
| `esr-153.0` | `153.0` | 122 | supported | product default and latest ESR |
| `esr-140.13` | `140.13` | 112 | supported | supported older ESR |
| `esr-115.39` | `115.39` | 97 | supported | supported older ESR |

The policy union contains 123 stable IDs. 97 policies occur in all four
artifacts. 15 policies remain available in ESR 140.13 and the
153 artifacts but not ESR 115.39; 10 policies are available only
