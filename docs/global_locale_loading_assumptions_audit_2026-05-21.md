...
| `docs/ui_locale_glossary_en_ru_2026-05-15.md` | Glossary scope previously implied supported UI locales remain only `en` and `ru`. | Updated in `GLOC-005` to mark the file as the historical EN/RU reference until `GLOC-103` / `GLOC-702` supersedes it with a six-locale terminology sheet. |
