...
Step 8 opens correctly, but the first visible content is generic schema-shell technical coverage text: "Most common settings are available here..." and "Open JSON editor for this step". This makes the final step feel like another technical review step instead of the export destination.
