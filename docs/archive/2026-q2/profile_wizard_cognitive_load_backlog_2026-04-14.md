...
3. `UX-CL-32` Replace Firefox Home fine-tuning grid with grouped toggles. - Completed
   ...
   Delivered: Firefox Home keeps Search, Top sites, and Pocket visible, while stories/sponsored content, snippets, and layout/json Home policies are grouped into collapsed fine-tuning disclosures.
...
- Provider details do not imply full guided support when they still require JSON editor.
