...
def test_list_filters_include_deleted_sort_and_pagination():
    ...
    r1 = client.post("/api/profiles", json=_mk("LF-A", "esr-140.13"))
    r2 = client.post("/api/profiles", json=_mk("LF-B", "esr-140.13"))
    r3 = client.post("/api/profiles", json=_mk("LF-C", "esr-140.13"))
