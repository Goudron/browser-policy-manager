...
def test_controller_returns_an_immediate_local_time_preview_without_waiting_for_generation() -> (
    None
):
    ...
    def preview(request: ConversationRequest, *, queued: bool) -> ConversationTimePreview:
        observed.append((request.timing_context_characters, request.timing_evidence_tokens, queued))
    ...
    class ExternalOrchestrator:
        def ask(
            ...
            *,
            ...
            local = LocalCitation("topic:alpha", "/help/en/user/alpha.html", "alpha", "root")
