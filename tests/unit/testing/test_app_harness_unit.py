...
def test_fresh_test_app_builds_distinct_application_instances():
    ...
    assert first.state.database_runtime is not second.state.database_runtime
    assert first.state.database_runtime.engine is None
    assert second.state.database_runtime.engine is None
