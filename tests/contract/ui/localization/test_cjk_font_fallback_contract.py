...
AUDIT_DOC_PATH = doc_path_from_index("cjk_font_fallback_audit_2026-05-30.md", status="audit")
...
def test_monospace_font_stacks_include_cjk_fallbacks():
    ...
    mono_declarations = [
        line.strip() for line in css_source.splitlines() if 'font-family: "IBM Plex Mono"' in line
    ]
