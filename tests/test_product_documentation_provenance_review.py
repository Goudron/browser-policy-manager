...
def test_provenance_matrix_covers_every_required_source_family_and_guide():
    ...
    assert sources["bpm-openapi-contract"]["guide_families"] == ["api-integration-guide", "administrator-guide"]
...
def test_localization_and_generated_output_inherit_provenance_without_ai():
    ...
    assert any("Unreviewed AI or machine-generated translation" in rule for rule in localized["forbidden_reuse"])
