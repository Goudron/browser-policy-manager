#!/usr/bin/env python3
"""Build and smoke-test BPM 0.9.5 native Linux distribution packages.
...
def load_targets() -> dict[str, Target]:
    ...
    if payload.get("target_bpm_version") != TARGET_VERSION:
        raise NativeDistributionError("native target manifest must match BPM 0.9.5")
