...
def render_summary(inventory: dict[str, Any]) -> str:
    ...
    return f"""# Firefox Policy Documentation Inventory (BPM 0.9.6)
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build the BPM 0.9.6 Firefox policy documentation inventory."
    )
    parser.add_argument(
        "--check",
        action="store_true",
