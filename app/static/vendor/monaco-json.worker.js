(() => {
  ...
  var _StringEdit = class _StringEdit extends BaseStringEdit {
  ...
  var _AsyncIterableProducer = class _AsyncIterableProducer {
  ...
  var AsyncIterableProducer = _AsyncIterableProducer;
