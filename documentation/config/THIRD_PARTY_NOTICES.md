...
| Eclipse Temurin JRE (HotSpot) | 21.0.12.1+1 | GPL-2.0 with Classpath Exception; bundled third-party notices apply | `adoptium/temurin21-binaries` official release |
...
| Pygments | 2.21.0 | BSD-2-Clause | PyPI |
