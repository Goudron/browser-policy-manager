...
def test_m11_01_refreshes_only_verified_published_artifacts_atomically() -> None:
    contract = json.loads((ROOT / "documentation/config/documentation-artifact-refresh-contract-0.9.3.json").read_text())
    generation = (ROOT / "documentation/tools/generate_chat_rag_exact_generations_0_9_3.py").read_text()
